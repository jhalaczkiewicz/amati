...
(:
 ...
 :)
declare variable $config:default-template :="poslowie-2.html";
...
(:~
 ...
 :)
declare variable $config:default-odd :="poslowie-japonscy.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("poslowie-japonscy.odd");
